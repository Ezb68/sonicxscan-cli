...
var Sonicx_pb = require('./Sonicx_pb.js');
...
proto.protocol.CreateSmartContract.toObject = function(includeInstance, msg) {
  var f, obj = {
    ownerAddress: msg.getOwnerAddress_asB64(),
    newContract: (f = msg.getNewContract()) && Sonicx_pb.SmartContract.toObject(includeInstance, f),
...
proto.protocol.CreateSmartContract.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new Sonicx_pb.SmartContract;
      reader.readMessage(value,Sonicx_pb.SmartContract.deserializeBinaryFromReader);
...
proto.protocol.CreateSmartContract.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      Sonicx_pb.SmartContract.serializeBinaryToWriter
    );
  }
...
proto.protocol.CreateSmartContract.prototype.getNewContract = function() {
  return /** @type{?proto.protocol.SmartContract} */ (
    jspb.Message.getWrapperField(this, Sonicx_pb.SmartContract, 2));
};
...
proto.protocol.AccountPermissionUpdateContract.toObject = function(includeInstance, msg) {
  var f, obj = {
    ownerAddress: msg.getOwnerAddress_asB64(),
    owner: (f = msg.getOwner()) && Sonicx_pb.Permission.toObject(includeInstance, f),
    witness: (f = msg.getWitness()) && Sonicx_pb.Permission.toObject(includeInstance, f),
    activesList: jspb.Message.toObjectList(msg.getActivesList(),
    Sonicx_pb.Permission.toObject, includeInstance)
  };
...
proto.protocol.AccountPermissionUpdateContract.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new Sonicx_pb.Permission;
      reader.readMessage(value,Sonicx_pb.Permission.deserializeBinaryFromReader);
      msg.setOwner(value);
      break;
    case 3:
      var value = new Sonicx_pb.Permission;
...
proto.protocol.AccountPermissionUpdateContract.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      Sonicx_pb.Permission.serializeBinaryToWriter
    );
  }
...
proto.protocol.AccountPermissionUpdateContract.prototype.getOwner = function() {
  return /** @type{?proto.protocol.Permission} */ (
    jspb.Message.getWrapperField(this, Sonicx_pb.Permission, 2));
};
...
proto.protocol.AccountPermissionUpdateContract.prototype.getWitness = function() {
  return /** @type{?proto.protocol.Permission} */ (
    jspb.Message.getWrapperField(this, Sonicx_pb.Permission, 3));
};
...
proto.protocol.AccountPermissionUpdateContract.prototype.getActivesList = function() {
  return /** @type{!Array.<!proto.protocol.Permission>} */ (
    jspb.Message.getRepeatedWrapperField(this, Sonicx_pb.Permission, 4));
};
